...
class DatabaseInfoPanel implements Tracy\IBarPanel
{
	 ...
	 */
	public function __construct($databaseParams, $customDbNameKey = NULL, IDatabaseInfoPanelStyleHandler $styleCallback = NULL)
	{
	...
	private function setDatabaseParams($databaseParams)
	{
