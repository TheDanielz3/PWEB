...
abstract class Connection
{
	...
	protected function __construct($info)
	{
		try
		{
            ...
            /**
             *  Inserted by Smendespt
			 *  Replacing standard PDO for PDO with hooks for Tracy Bar
             */
            $this->connection = new \Filisko\PDOplus\PDO("$info->protocol:$host;dbname=$info->db",$info->user,$info->pass,static::$PDO_OPTIONS);
